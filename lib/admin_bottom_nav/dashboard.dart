              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(children: [
                    ...
                    FutureBuilder(
                      future: _fireStoreService.getUsersNotApprovedWithLimit(5),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            List<int> foundCountData =
                                _countDatesInLast7Days(postedTimes!['found']!);
                            ...
                            final foundItemsData = List.generate(7, (index) {
                              ...
                              return FlSpot(
                                ...
                                foundCountData[index].toDouble(), // Count value
                              );
                            });
                            ...
                            final lostItemsData = List.generate(7, (index) {
                              ...
                              return FlSpot(
                                (index + 1).toDouble(), // Day number (1-7)
                                lostCountData[index].toDouble(), // Count value
                              );
                            });
                    ...
                    FutureBuilder(
                        //recent updates
                        future:
                            _fireStoreService.getLostAndFoundItemsWithLimit(3),
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                              ConnectionState.waiting) {
                            return Center(child: CircularProgressIndicator());
